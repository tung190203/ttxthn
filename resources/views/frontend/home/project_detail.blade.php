...
@section('content')
    <div class="page__content">
        ...
        <section class="section pb-0" id="vi-tri">
            <div class="container">
                <h2 class="section__title">Vị trí</h2><img class="w-100" src="{{asset('./images/position.jpg')}}" alt="">
            </div>
        </section>
        ...
        <section class="position-relative" id="sa-ban-ao">
            <div class="section section--overlay">
                <div class="container">
                    ...
                    <div class="mt-3">
                        <a href="{{$project->link_vrtour}}" class="btn btn-warning text-white custom-btn-vrtour" target="_blank" rel="noopener noreferrer">
                            Xem VR Tour
                        </a>
                    </div>
                </div>
                ...
                <div class="design-slider">
                    <div class="design-slider__container swiper-container">
                        <div class="swiper-wrapper">
                            @php
                            $design_images = explode(';', $project->design_images ?? '');
                            $design_descs = json_decode($project->design_description ?? '[]', true);
                            ...
                            <div class="design-slider__slide swiper-slide">
                                <div class="design-slider__frame"><img src="{{$design_images[$i]}}" alt="" /></div>
        ...
        <section class="section" id="tin-tuc"><img class="texture-1" src="{{asset('./images/texture-1.png')}}" alt=""><img
                class="texture-2" src="{{asset('./images/texture-2.png')}}" alt="">
            <div class="container">
