            ...
            <div class="pj-banner__wrapper custom-wrapper">
                <div class="container">
                    ...
                    <div class="custom_desc">Cụm công nghiệp CN2 (50,5ha), tọa lạc tại xã Mai Đình, huyện Sóc Sơn, Hà Nội,
                        có thời hạn thuê đất đến 50 năm. Dự án ưu tiên thu hút các doanh nghiệp công nghệ cao, sản xuất hiện
                        đại, thân thiện môi trường và các công ty trong lĩnh vực hàng không, dịch vụ sân bay.
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section" id="thong-tin-chung"><img class="section__bg" src="./images/achitect-bg.png"
            ...
            <div class="container">
                ...
                <div class="mx-auto" style="max-width: 800px;">
                    <p>Cụm công nghiệp CN2 là một mắt xích quan trọng trong định hướng phát triển công nghiệp sạch, công
                        nghệ cao tại cửa ngõ phía Bắc Thủ đô. Dự án không chỉ nằm gần Cảng hàng không quốc tế Nội Bài mà còn
                        được quy hoạch đồng bộ, hạ tầng hoàn thiện, sẵn sàng đón các doanh nghiệp sản xuất quy mô vừa và lớn
                        trong các lĩnh vực công nghệ cao, phụ trợ hàng không, logistics và công nghiệp thân thiện với môi
                        trường.</p>
                    <ul>
                        ...
                        <li><strong>Hạ tầng</strong>: Giao thông kết nối thuận tiện, hệ thống điện – nước – viễn thông đầy
                            đủ, đất công nghiệp phân lô sẵn sàng bàn giao</li>
                        <li><strong>Hình thức khai thác</strong>: Cho thuê đất/nhà xưởng với thời hạn tối đa 50 năm</li>
                        <li><strong>Đối tượng thu hút</strong>: Doanh nghiệp sản xuất công nghệ cao, phụ trợ hàng không,
                            logistics, công nghiệp sạch
                        </li>
                        ...
                        <li><strong>Hiện trạng đất</strong>: Đã hoàn thành giải phóng mặt bằng, hạ tầng sẵn sàng khai thác
                        </li>
                        <li><strong>Phù hợp quy hoạch</strong>: Phù hợp Quy hoạch phát triển các cụm công nghiệp TP. Hà Nội
                            đến năm 2030, tầm nhìn 2050
                        </li>
                        <li><strong>Đơn vị phát triển</strong>: Công ty TNHH Hạ tầng và Phát triển Khu công nghiệp ASG
                            (ASGI)</li>
                        ...
                        <div class="advantage__body">
                            ...
                            <div class="advantage__desc">
                                <p>Cụm công nghiệp CN2 nằm gần sân bay quốc tế Nội Bài (chỉ 5 phút di chuyển), cách trung
                                    ...
                                    Bài – Lào Cai, Nội Bài – Thái Nguyên và Nội Bài – Bắc Ninh – Hạ Long. Từ đây, chỉ mất
                                    khoảng 30 phút để đến các khu công nghiệp lớn như Samsung Thái Nguyên và Samsung Bắc
                                    Ninh.</p>
                            </div>
                        </div>
                    </div>
                    <div class="advantage mt-20"><a class="advantage__frame" href="#!"><img
                        ...
                        <div class="advantage__body">
                            ...
                            <div class="advantage__desc">
                                ...
                                <p>Hình thành khu vực công nghiệp tập trung đa ngành nghề. Trong đó, ưu tiên phát triển công
                                    nghiệp điện tử – công nghệ thông tin, cơ khí, sản xuất ô tô, công nghiệp vật liệu mới,
                                    hóa dược – mỹ phẩm, dệt may… Đồng thời, đầu tư xây dựng đồng bộ hạ tầng kỹ thuật, hạ
                                    tầng xã hội, khu nhà ở công nhân và các công trình phụ trợ phục vụ khu công nghiệp;</p>
                            </div>
                        </div>
                    </div>
                    <div class="advantage mt-20"><a class="advantage__frame" href="#!"><img
                        ...
                        <div class="advantage__body">
                            ...
                            <div class="advantage__desc">
                                <p>Cụm công nghiệp CN2 được đầu tư hạ tầng hiện đại, đồng bộ. Dự án cấp điện từ trạm 110kV
                                    ...
                                    Viễn thông kết nối đến từng lô đất. Tiện ích đi kèm gồm văn phòng cho thuê, bãi đỗ xe,
                                    khu giao dịch ngân hàng, trưng bày sản phẩm và dịch vụ hỗ trợ cho chuyên gia, quản lý,
                                    công nhân.</p>
                            </div>
                        </div>
                    </div>
