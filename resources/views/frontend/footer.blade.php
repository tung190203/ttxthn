        ...
        <div class="container">
            <div class="d-flex justify-content-start align-items-center mb-4">
                ...
                <div class="ms-3">
                    ...
                    <div class="footer__title custom-text-footer">TRUNG TÂM XÚC TIẾN ĐẦU TƯ VÀ HỖ TRỢ DOANH NGHIỆP HÀ NỘI</div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-7 mb-40 mb-lg-0">
                    <ul class="f-contact">
                        <li><i class="fal fa-fw fa-map-marker-alt me-2"></i><span>Địa chỉ: Khu liên cơ quan Vân Hồ, 52
                                Lê Đại Hành, phường Hai Bà Trưng, Hà Nội</span>
                        </li>
