...
return [
    ...
    'loading' => 'Đang tải...',
    'news' => 'Tin tức',
    'investment_projects' => 'Dự án thu hút đầu tư',
    ...
    'forgot_password_desc' => 'Nhập email tài khoản để nhận liên kết đặt lại mật khẩu.',
    'send_reset_link' => 'Gửi liên kết đặt lại',
    'reset_password' => 'Đặt lại mật khẩu',
    'reset_link_sent' => 'Đã gửi liên kết đặt lại mật khẩu',
    'check_email_reset_link' => 'Vui lòng kiểm tra email để tiếp tục.',
    'back_to_login' => 'Quay lại đăng nhập',
    'generic_error' => 'Có lỗi xảy ra, vui lòng thử lại!',
    'reset_password_email_subject' => 'Đặt lại mật khẩu',
    'reset_password_email_intro' => 'Bạn nhận được email này vì chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn.',
    'reset_password_email_expire' => 'Liên kết đặt lại mật khẩu sẽ hết hạn sau 60 phút.',
    'reset_password_email_ignore' => 'Nếu bạn không yêu cầu đặt lại mật khẩu, vui lòng bỏ qua email này.',
    'edit' => 'Chỉnh sửa',
    ...
    'news_link' => 'tin-tuc-su-kien',
    'contact_link' => 'lien-he',
    'project_link' => 'du-an-thu-hut-dau-tu',
    ...
    'explore_projects' => 'Tìm hiểu dự án',
    'discover_hanoi' => 'Xem thêm về Hà Nội',
    'key_projects' => 'Dự án trọng điểm',
    'outstanding_investment_opportunities' => 'Cơ hội đầu tư <span style="color: #1677ff;">nổi bật</span>',
    'total_capital' => 'Tổng vốn',
    'length' => 'Chiều dài',
    'area' => 'Diện tích',
    'policies_and_incentives' => 'Chính sách & ưu đãi',
    'investment_incentives' => 'Ưu đãi đầu tư',
    'view_all_incentives' => 'Xem toàn bộ chính sách',
    'news_and_events' => 'Tin tức và sự kiện',
    'latest_updates' => 'Cập nhật <span style="color: #1677ff;">mới nhất</span>',
    'read_more' => 'Đọc thêm',
    'subscribe_newsletter_desc' => 'Cập nhật cơ hội đầu tư mới nhất trực tiếp vào hộp thư của bạn',
