...
$config['licenseName'] = env('CKFINDER_LICENSE_NAME', 'ducnh.com');
$config['licenseKey']  = env('CKFINDER_LICENSE_KEY', '*T?V-*1**-6**X-*7**-*Q**-M*N*-3**B');
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'images',
    'maxSize'           => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,webp,svg,ico,webp',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
