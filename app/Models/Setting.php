...
class Setting extends Model
{
    ...
    public static function getAllSetting()
    {
        ...
        foreach ($settings as $setting) {
            ...
            $multiLangKeys = ['site_name', 'footer_info', 'copyright_notice', 'copyright', 'address', 'social_title', 'logo', 'chatbot_name', 'chatbot_tooltip', 'chatbot_welcome_message', 'contact_auto_reply_message'];
